...
<template>
  <div style="line-height: 40px;">
    <zy-read-write-switch :data="click" v-model="write">
      <el-input v-model="click" @blur="write = false" />
    </zy-read-write-switch>
  </div>

  <div style="line-height: 40px;">
    <zy-read-write-switch :data="dblclick" v-model="write2" write-trigger="onDblclick">
      <el-input v-model="dblclick" @blur="write2 = false" />
    </zy-read-write-switch>
  </div>

  <div style="line-height: 40px;">
    <zy-read-write-switch :data="manual" v-model="write3" write-trigger="manual">
