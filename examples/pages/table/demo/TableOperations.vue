...
<template>
  ...
  <zy-table :data="tableData" :columns="columns">
    ...
    <zy-table-operations :ellipsis="2" :buttons="buttons" label="操作" fixed="right" />
  </zy-table>
  <h4>
    icon 按钮
  </h4>
  <zy-table :data="tableData" :columns="columns" style="margin-top: 20px">
    <el-table-column type="selection"></el-table-column>
    <el-table-column prop="date" label="日期" min-width="180"></el-table-column>
    <el-table-column prop="name" label="姓名" min-width="180" fix></el-table-column>
    <el-table-column prop="address" label="地址" min-width="300" :show="false"></el-table-column>
    <zy-table-operations :ellipsis="2" type="icon" :buttons="buttons" label="操作" fixed="right" />
  </zy-table>
</template>
