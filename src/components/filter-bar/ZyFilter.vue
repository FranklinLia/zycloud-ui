<template>
  <div class="zy-filter" ref="filterRef" v-show="show">
    ...
    <div class="zy-filter__scroll" @mousedown="left" @mouseup="mouseup" v-if="scroll">
      <el-icon>
        <ArrowLeftBold/>
      </el-icon>
    </div>

    <zy-filter-conditions :conditions="conditions" @change="change" ref="conditionsRef"/>

    <div class="zy-filter__scroll" @mousedown="right" @mouseup="mouseup" v-if="scroll">
      <el-icon>
        <ArrowRightBold/>
      </el-icon>
    </div>

    <div class="zy-filter__clear zy-scale-click" @click="clear" v-if="conditions.length > 0">
      <el-icon>
        <Delete/>
      </el-icon>
...
import ZyFilterConditions from "./ZyFilterConditions.vue";
...
defineOptions({name: "ZyFilter"});
const {t} = useLocale()

const filterRef = ref<HTMLElement | null>(null)
const conditionsRef = ref<InstanceType<typeof ZyFilterConditions> | null>(null)
