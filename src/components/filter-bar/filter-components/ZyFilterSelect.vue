<template>
  <div class="zy-filter-component">
    ...
    <div class="zy-filter-component__content">
      <zy-filter-option :label="o.label" :value="o.value" v-for="o in showOptions" :key="o.value"/>
...
import ZyFilterOption from "./ZyFilterOption.vue";
...
defineOptions({name: "ZyFilterSelect"});
