<template>
  <el-popover :visible="active" :show-arrow="false" @hide="hide" width="auto" popper-class="zy-complex-components">
    <div class="zy-complex-components">
      <div class="zy-complex-components__body">
        <slot>
    ...
    <template #reference>
      <el-button circle icon="ArrowRightBold" @click="toggle" :size="configSize" v-show="showComplex"
                 :class="['zy-complex-components-trigger', {'is-active':active}]"/>
    </template>
  </el-popover>
</template>
...
defineOptions({name: "ZyComplexSearch"});
