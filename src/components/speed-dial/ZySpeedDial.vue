<template>
  <div class="zy-speed-dial" :style="style" v-click-outside="outsideClickClose">
    <div class="zy-speed-dial__content">
      <slot name="fab">
        <zy-speed-dial-button v-bind="buttonProps" @click="click" @mousedown="mousedown"/>
      </slot>
      <div :style="contentPosition">
        <slot>
          <zy-speed-dial-item v-for="(item, index) in items" :index="index" :key="index" v-bind="item"
...
import ZySpeedDialButton from "@/components/speed-dial/ZySpeedDialButton.vue"
import ZySpeedDialItem from "@/components/speed-dial/ZySpeedDialItem.vue"
import {SpeedDialKey} from "./types";

defineOptions({name: "ZySpeedDial"});
