<template>
  <div class="zy-speed-dial-action-button">
    <div v-if="title" class="zy-speed-dial-action-button__title" :style="titleSize">
      <slot name="title">
        <div class="zy-speed-dial-action-button__text" :class="titleClass" :style="titleStyle" @click="click">{{ title
        }}
        </div>
      </slot>
    </div>
    <slot>
      <zy-speed-dial-button :class="buttonClass" v-bind="buttonProps" :icon="icon" @click="click" />
    </slot>
  </div>
</template>
