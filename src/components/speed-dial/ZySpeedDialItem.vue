<template>
  <transition :css="false" @before-enter="beforeEnter" @enter="enter" @leave="leave">
    <div v-if="isActive" class="zy-speed-dial-item" :style="itemSize">
      <slot>
        <zy-speed-dial-action-button :index="index" v-bind="$attrs" />
      </slot>
    </div>
  </transition>
</template>
...
import ZySpeedDialActionButton from "@/components/speed-dial/ZySpeedDialActionButton.vue";
import { SpeedDialKey } from "./types";
defineOptions({ name: "ZySpeedDialItem" });
