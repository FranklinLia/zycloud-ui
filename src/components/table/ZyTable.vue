<template>
  <el-table class="zy-table" v-bind="$attrs" :key="key" header-row-class-name="zy-table-header" ref="refElTable">
    <zy-table-body name="table-body" :columns="columns">
      <slot/>
    </zy-table-body>
